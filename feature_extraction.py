...
# DEFINE A FUNCTION THAT OPENS A HTML FILE AND RETURNS THE CONTENT
file_name = "html_dataset/5.html"
...
# DEFINE A FUNCTION THAT CREATES A BEATIFULSOUP OBJECT
...
#  RUN STEP 1,2,3 FOR ALL HTML FILES AND CREATE A 2-D ARRAY
folder = "html_dataset"
...
# Run feature extraction and create a vector
soup = create_soup(open_file(file_name))
